  ...
  return (
    <div>
      <div className="flex flex-col w-full justify-center my-8">
        ...
        <PageContainer>
          <div className="flex flex-col max-w-6xl m-auto">
            <div className="mt-10 mb-10 w-full sm:w-full md:w-1/2 lg:w-1/2">
              ...
              <p className="text-xl text-blue mb-5">
                ...
                visual elements from classic animation, games, and old software.
              </p>
              <p className="text-xl text-blue mb-5">
          ...
          <div className="flex flex-col max-w-6xl  m-auto">
            ...
            <div className="mt-10 mb-20 sm:ml-20 md:ml-20 lg:ml-20 w-full sm:w-full md:w-1/2 lg:w-1/22">
              <img alt="Early Exploration Two" src={earlyExplorationTwoImage} />
              <span className="block mt-2 text-md text-blue">
        ...
        <PageContainer>
          <div className="mt-10 mb-10 w-full">
            <h3 className="mb-2 text-blue font-bold text-3xl">Spreading Good Vibes</h3>
            <p className="text-xl text-blue mb-5">
              Ultimately, we don’t want our retrospectives to feel like a chore. They
              truly can provide so much value to teams when conducted well. Using playful
              imagery and gentle primary colors was our visual answer to breaking the
              tedium.
            </p>
            <p className="text-xl text-blue mb-5">
      ...
      <div className="w-full flex justify-center items-center">
        <img alt="Good Vibes" src={goodVibesImage} />
      </div>
      <div
        style={{
