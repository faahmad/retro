    ...
    <PageContainer>
      <div className="text-blue">
        <div>
          ...
          <div />
          <div>
            <p>Last updated March 15, 2020</p>
          </div>
          <div className="mt-8">
          ...
          <div>
            ...
            whether personally or on behalf of an entity (&ldquo;you&rdquo;) and Retro
            Technology LLC.&nbsp;("
            <strong>Company</strong>", &ldquo;<strong>we</strong>&rdquo;, &ldquo;
            <strong>us</strong>&rdquo;, or &ldquo;<strong>our</strong>
            &rdquo;), concerning your access to and use of the{" "}
            <a href="https://retro.app/">https://retro.app/</a> website as well as any
            other media form, media channel, mobile website or mobile application related,
            linked, or otherwise connected thereto (collectively, the &ldquo;Site&rdquo;).
            You agree that by accessing the Site, you have read, understood, and agree to
            be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE
          ...
          <div>
            ...
            legal capacity and you agree to comply with these Terms of Use; (4) you are
            not a minor in the jurisdiction in which you reside;&nbsp;(5) you will not
          ...
          <div>
            ...
            <div>
              ...
              any such amounts upon making your purchase. If&nbsp;your purchase is subject
          ...
          <div>
            ...
            <div>4. Use the Site to advertise or offer to sell goods and services.</div>
            <div>
            ...
            <div>6. Engage in unauthorized framing of or linking to the Site.</div>
            <div>
            ...
            <div>12. Sell or otherwise transfer your profile.</div>
            <div>
            ...
            <div>
              19. Copy or adapt the Site&rsquo;s software, including but not limited to
            ...
            <div>
              ...
              party&rsquo;s uninterrupted use and enjoyment of the Site or modifies,
            ...
            <div>
              ...
              (&ldquo;gifs&rdquo;), 1&times;1 pixels, web bugs, cookies, or other similar
              devices (sometimes referred to as &ldquo;spyware&rdquo; or &ldquo;passive
              collection mechanisms&rdquo; or &ldquo;pcms&rdquo;).
            </div>
            <div>
        ...
        <div>
          ...
          <div>
            ...
            <div>
              ...
              acquired by or on behalf of any agency not within the Department of Defense
              (&ldquo;DOD&rdquo;), our services are subject to the terms of these Terms of
              Use in accordance with FAR 12.212 (for computer software) and FAR 12.211
              (for technical data). If our services are acquired by or on behalf of any
              agency within the Department of Defense, our services are subject to the
              terms of these Terms of Use in accordance with Defense Federal Acquisition
              Regulation (&ldquo;DFARS&rdquo;) 227.7202‑3. In addition, DFARS 252.227‑7015
        ...
        <div>
          ...
          <div>
            ...
            provided below (a &ldquo;Notification&rdquo;). A copy of your Notification
        ...
        <div>
          <div>
            ...
            &ldquo;Disputes&rdquo;) brought by either you or us (individually, a
            &ldquo;Party&rdquo; and collectively, the &ldquo;Parties&rdquo;), the Parties
        ...
        <div>
          ...
          the AAA&rsquo;s Supplementary Procedures for Consumer Related Disputes ("AAA
          Consumer Rules"), both of which are available at the AAA website{" "}
          <a href="http://www.adr.org">www.adr.org</a>. Your arbitration fees and your
          ...
          applicable law, the arbitration will&nbsp;take place in Queens, New York. Except
        ...
        <div>
          ...
          courts&nbsp;located in Queens, New York, and the Parties hereby consent to, and
        ...
        <div>
          ...
          COMPLETENESS OF THE SITE&rsquo;S CONTENT OR THE CONTENT OF ANY WEBSITES LINKED
          ...
          CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT
          OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA
          THE SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR
          ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SITE,
        ...
        <div>
          ...
          TO ANY CAUSE OF ACTION&nbsp;ARISING OR $150.00 USD. CERTAIN US STATE LAWS AND
        ...
        <div>
          ...
          due to or arising out of: (1) your Contributions;&nbsp;(2) use of the Site; (3)
        ...
        <div>
          <strong>Retro Technology LLC.</strong>
        </div>
        <div>
          <strong>28-10 Jackson Avenue</strong>
        </div>
        <div>
          <strong>
            Long Island City<strong>, NY</strong>
            <strong> 11101</strong>
          </strong>
        </div>
        <div>
